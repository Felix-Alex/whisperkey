...
- [ ] **T005 [scaffold] tauri.conf.json 基础配置**
  - 📥 输入：T004
...
- [ ] **T006 [error] 定义 AppError 与 AppResult**
...
- [ ] **T010 [config] config.json schema 类型**
...
- [ ] **T013 [hotkey] HotkeyConfig 数据模型 + 转换**
  - 📥 输入：T011
...
- [ ] **T014 [hotkey] RegisterHotKey + 消息泵线程**
...
- [ ] **T018 [asr] AsrProvider trait + Registry**
  - 📥 输入：T012
...
- [ ] **T022 [llm] LlmProvider trait + Prompts**
...
- [ ] **T023 [llm] OpenAI 兼容协议实现（OpenAI/DeepSeek/Qwen/Doubao）**
...
- [ ] **T030 [inject] SendInput Unicode 逐字符回退**
  - 📥 输入：T029
